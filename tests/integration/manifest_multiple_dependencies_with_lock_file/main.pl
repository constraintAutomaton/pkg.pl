...
test("the package report is valid", (
        ...
        list_to_ord_set([
            ...
            install_locked_dependency(dependency("test",git("https://github.com/constraintAutomaton/test-prolog-package-manager.git",hash("bb3e0d96153df606ef8030b2a95d5d9024793e79"))))-success,
